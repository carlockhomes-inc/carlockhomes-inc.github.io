...
dst = r'backup_topics\preview.html'
...
lines[680] = '            <p style="font-size:14px;opacity:0.95;line-height:1.6;">外部パートナー企業様による特別寄稿。CLHの最新ビジョンと社会貢献の舞台裏に迫ります。</p>\n'
lines[681] = '            <!-- line cleared for topics update -->\n'

# News
lines[687] = '                <div style="font-size:13px;font-weight:900;opacity:0.8;">NEWS</div>\n'
...
print("FILE_UPDATED: backup_topics/preview.html")
