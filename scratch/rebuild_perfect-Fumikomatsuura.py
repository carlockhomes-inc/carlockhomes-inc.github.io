...
dst = r'preview_perfect.html'

with open(src, 'r', encoding='utf-8', errors='ignore') as f:
    content = f.read()

# Update content directly in the full string
content = content.replace('RECRUIT 2026', 'TOPICS')

# Replace title and para (searching for parts since they might have different spacing)
